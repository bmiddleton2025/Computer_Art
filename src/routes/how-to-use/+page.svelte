		...
		<div class="space-y-2">
			...
			<div class="ml-10 w-fit space-y-2">
				...
				<ul class="ml-10 list-decimal space-y-2">
					...
					<li>
						Right next to the icon name select box there is a copy button that when clicked will copy the name of the icon.
						<Icon icon="line-md:clipboard-arrow" width="24" class="inline-block" />
					</li>
					<li>Back in settings, replace the icon name with your new one.</li>
				</ul>
			</div>
		</div>
		<div class="space-y-2">
